...
This project currently uses original placeholder visual assets created specifically for Insurance Company Tycoon using HTML, CSS, JavaScript and Phaser Graphics.
...
If external assets are added later, only use CC0, public-domain, or clearly commercial-use-compatible assets, and record each item in this file before shipping. Do not include unclear-licence assets.
